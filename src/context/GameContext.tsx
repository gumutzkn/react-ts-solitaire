...
export const GameProvider = React.memo(
  ({ children }: GameProviderProps) => {
    ...
    const handleDrop = useCallback(
      (cardId: string, fromColumnId: number, toColumnId: number) => {
      ...
      [remainingCardsDeck, visibleRemainingCards]
    );

    const handleRemainingCardClick = useCallback(() => {
    ...
    }, [columns, remainingCardsDeck, visibleRemainingCards]);
